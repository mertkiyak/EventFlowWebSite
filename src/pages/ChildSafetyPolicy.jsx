...
const ChildSafetyPolicy = () => {
                ...
                <div style={{ color: '#1C1C1E', lineHeight: '1.8', fontSize: '16px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    <section>
                        ...
                        <p style={{ color: '#6B7280' }}>
                            ...
                            <br />
                            In accordance with global child protection standards and our strict 18+ policy, EventFlow is designed not to serve any individuals under the age of 18 and enforces this restriction with a strict age verification algorithm. This ensures full compliance with the United States Children's Online Privacy Protection Act (COPPA) and the European Union General Data Protection Regulation (GDPR-K).
                            <br /><br />
    ...
    return false;
                            ...
                            An analysis of this code snippet demonstrates that the system only accepts valid numerical values (isNaN(ageNum) check) and stops the registration process for individuals under 18 on the client side before any data is sent to the server. Furthermore, an upper limit of 120 years has been set to prevent meaningless data entries (API Abuse).
                            <br /><br />
                            However, it is a known behavioral pattern for underage individuals to fake their age (age-faking) to bypass age gates. In compliance with these guidelines and laws, EventFlow is designed to add a temporary restriction flag to the local storage of a device that has been rejected for entering an age under 18, preventing the user from returning and creating a new account by increasing their age. This is a requirement of the "Neutral Age Gate" principle.
                            <br /><br />
                            ...
                            <ul style={{ paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '8px', marginBottom: '8px' }}>
                                <li><strong>everyone:</strong> Allows the user to receive messages from anyone on the platform.</li>
                                <li><strong>followers_only:</strong> Allows the user to receive messages only from people they have authorized, follow, or mutually follow. This structured permission mechanism is a critical barrier against unwanted contact.</li>
                            </ul>
                            ...
                            <br /><br />
                            To minimize the risks associated with physical meetups, EventFlow takes into account the guiding principles of user safety. In-app Safety Notices will be integrated advising that if meeting someone met on the app in real life, these meetings should always take place in public, crowded environments.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p style={{ color: '#6B7280' }}>
                            ...
                            <ul style={{ paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '8px', marginBottom: '8px' }}>
                                ...
                                <li><strong>Transmitting Adult Content to Minors:</strong> Taking advantage of the platform to send explicit content, sexual propositions, or messages to individuals under the age of 18. As our platform is strictly 18+, any discovery of minor accounts will lead to their immediate removal, and any attempt by adult users to solicit minors will be met with a permanent ban and reporting to authorities.</li>
                    ...
                    <section>
                        ...
                        <p style={{ color: '#6B7280' }}>
                            ...
                            <ul style={{ paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '8px', marginBottom: '8px' }}>
                                <li><strong>Under 18 User Ban:</strong> The application technically blocks the registration of users under 18. If data belonging to a minor under 18 is found to have been collected accidentally or intentionally, this data is immediately and irreversibly deleted from the servers.</li>
                    ...
                    <section>
                        <h2 style={{ fontSize: '22px', marginBottom: '16px' }}>9. Safety and Digital Awareness</h2>
                        <p style={{ color: '#6B7280' }}>
                            Although EventFlow is strictly an 18+ application, we strongly advocate for digital safety awareness for all our users.
                            <br /><br />
                            Users are advised to implement the following fundamental safety practices:
                            <ul style={{ paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '8px', marginBottom: '8px' }}>
                                <li><strong>Physical Meetup Control:</strong> Ensure that any real-world meetup (O2O) with individuals met on the app takes place in public, well-lit places. Always inform a trusted friend or family member about your whereabouts.</li>
                                <li><strong>Privacy Settings:</strong> You can manage your message permissions to control who can contact you and enhance your digital privacy.</li>
                                <li><strong>Personal Data Awareness:</strong> Be mindful of the risks associated with sharing sensitive information like real names, home addresses, and daily routines with strangers in digital environments.</li>
                            </ul>
                        </p>
                    </section>
